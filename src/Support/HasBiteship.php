    ...
    public function createBiteshipOrder(OrderResponse $response): BiteshipOrder
    {
        return $this->biteshipOrder()->updateOrCreate(
            ...
            [
                ...
                'courier_company' => $response->courier_company,
                'courier_type' => $response->courier_type,
                'courier_tracking_id' => $response->courier_tracking_id,
                'shipping_cost' => $response->price,
                'insurance_cost' => $response->insurance_fee,
                'cod_amount' => $response->cod_fee,
