...
* add comprehensive configuration file, install command, and coordinate support for RateRequest DTOs ([2d52c4c](https://github.com/aliziodev/laravel-biteship/commit/2d52c4cd43d3d2506ab7d5f68cdb9b035282cd86))
